...
public class Constants {
	...
	public static Properties SignupOR;
	
	public static Properties ANDROIDGourmetOR;
	public static Properties GOURMETANDROIDtData;
	public static Properties ANDROIDShip2myidOR;
	public static Properties ANDROIDShip2myiData;
	public static Properties ANDROIDShip2myidsignupOR;
	public static Properties personalizeyourpreferencesOR;
	public static Properties ForgotpasswordOR;
	public static Properties HamburgermenuOR;
	public static Properties AndTestData;
	public static Properties NotificationOR;
}
